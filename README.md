# Analítica de Resultados Saber 11 — Caldas
...
## Ejecución
El producto final es un tablero interactivo desarrollado en **Dash** y desplegado en **AWS EC2**. Para correrlo localmente, instalar dependencias con `pip install -r despliegue/requirements.txt` y ejecutar `python despliegue/app.py`. Los datos fueron extraídos del portal [Datos Abiertos Colombia](https://www.datos.gov.co/Educaci-n/Resultados-nicos-Saber-11/kgxf-xxbe) usando AWS Glue y Athena.
